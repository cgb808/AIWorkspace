...
def calculate_final_epoch_count():
    ...
    original_strategy = {
        ...
        "phase_3_communication": {"epochs": 1, "focus": "Family-Oriented Communication"},
    ...
    advanced_hybrid_strategy = {
        "phase_1_foundation": {"epochs": 3, "focus": "Deep methodology + math integration"},
    ...
    print(f"  Estimated training time: {recommended_epochs * 2:.1f} hours (RTX 3060 Ti)")
...
def show_epoch_breakdown():
    ...
    epochs = [
        {"epoch": 1, "phase": "Foundation", "lr": "5e-05", "focus": "Initial methodology + math integration"},
        {"epoch": 2, "phase": "Foundation", "lr": "3e-05", "focus": "Strengthen foundation patterns"},
        {"epoch": 3, "phase": "Foundation", "lr": "2e-05", "focus": "Solidify integrated approaches"},
        {"epoch": 4, "phase": "Synthesis", "lr": "1e-05", "focus": "Refine pedagogical techniques"},
        {"epoch": 5, "phase": "Synthesis", "lr": "8e-06", "focus": "Perfect 50/50 balance"},
        {"epoch": 6, "phase": "Mastery", "lr": "5e-06", "focus": "Seamless integration mastery"},
        {"epoch": 7, "phase": "Mastery", "lr": "3e-06", "focus": "Stable high-quality responses"},
        {"epoch": 8, "phase": "Adaptation", "lr": "1e-06", "focus": "Contextual fine-tuning"}
    ]
    ...
    for epoch_info in epochs:
        ...
        print(f"  Examples: 1000 (500 methodology + 500 math+methodology)")
        print(f"  Training steps: 125")
        print()
