...
class InterruptionTrainingGenerator:
    ...
    def save_interruption_datasets(self, interruption_examples, session_examples):
        ...
        print(f"📄 Combined Dataset: {len(interruption_examples) + len(session_examples)} examples")
...
def main():
    ...
    # Save datasets
    results = generator.save_interruption_datasets(interruption_examples, session_examples)
