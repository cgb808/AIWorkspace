    ...
    def _create_domain_configuration(self) -> Dict[str, Any]:
        ...
        return {
            "mathematics": {
                ...
                "primary_tools": ["calculator", "graphing", "latex_renderer", "equation_solver"],
                "subdomain_mapping": {
                    "algebra": {
                    ...
                    "calculus": {
                        ...
                        "tools": ["derivative_calculator", "integral_solver", "graphing"],
            ...
            "english": {
                ...
                "primary_tools": ["text_analyzer", "writing_assistant", "literature_database"],
                "subdomain_mapping": {
                    "creative_writing": {
                        "focus": "Storytelling, character development, style, voice",
                        "tools": ["writing_prompts", "style_analyzer", "feedback_generator"],
                        "training_emphasis": "creative_guidance"
                    },
                    "reading_comprehension": {
                        "focus": "Analysis, inference, critical thinking, vocabulary",
                        "tools": ["passage_analyzer", "question_generator", "vocabulary_builder"],
                        "training_emphasis": "analytical_thinking"
                    },
                    "american_literature": {
                        "focus": "Historical context, themes, literary movements",
                        "tools": ["timeline_creator", "theme_analyzer", "context_provider"],
            ...
            "history": {
                ...
                "voice_preference": "jarvis",
                "primary_tools": ["timeline_creator", "map_generator", "primary_source_analyzer"],
                "subdomain_mapping": {
                    "civics": {
                        "focus": "Government systems, rights, civic participation",
                        "tools": ["government_structure", "rights_analyzer", "civic_engagement"],
                        "training_emphasis": "civic_understanding"
                    },
                    "world_history": {
                        "focus": "Global civilizations, cultural exchange, major events",
                        "tools": ["timeline_creator", "cultural_comparison", "event_analyzer"],
                        "training_emphasis": "global_perspective"
                    },
                    "us_history": {
                        "focus": "American development, key figures, national events",
                        "tools": ["timeline_creator", "document_analyzer", "figure_profiles"],
                    ...
                    "regional_history": {
                        ...
                        "subdomain_mapping": {
                            "west_virginia": {
                                ...
                                "tools": ["local_timeline", "industry_tracker", "cultural_analyzer"],
                    ...
                    "economics": {
                        ...
                        "tools": ["market_analyzer", "budget_calculator", "system_comparator"],
            ...
            "science": {
                ...
                "subdomain_mapping": {
                    ...
                    "botany": {
                        ...
                        "tools": ["plant_identifier", "growth_tracker", "classification_guide"],
                        "training_emphasis": "biological_classification"
                    },
                    "earth_science": {
                        "focus": "Geology, meteorology, hydrology, earth systems",
                        "tools": ["rock_identifier", "weather_tracker", "geological_timeline"],
            ...
            "foreign_language": {
                ...
                "voice_preference": "amy",
                "primary_tools": ["translator", "pronunciation_guide", "grammar_checker", "culture_guide"],
                "subdomain_mapping": {
                    "spanish": {
                        "focus": "Spanish grammar, vocabulary, Hispanic culture",
                        "tools": ["spanish_conjugator", "vocabulary_builder", "culture_explorer"],
                    ...
                    "french": {
                        ...
                        "tools": ["french_conjugator", "pronunciation_guide", "culture_explorer"],
                        "training_emphasis": "cultural_immersion",
                        "voice_preference": "french_native"
                    },
                    "italian": {
                        "focus": "Italian grammar, vocabulary, Italian culture",
                        "tools": ["italian_conjugator", "pronunciation_guide", "culture_explorer"],
            ...
            if "subdomain_mapping" in config:
                for subdomain, subconfig in config["subdomain_mapping"].items():
                    ...
                    if "subdomain_mapping" in subconfig:
                        for nested_sub, nested_config in subconfig["subdomain_mapping"].items():
...
"""
        ...
        if "subdomain_mapping" in config:
            for subdomain, subconfig in config["subdomain_mapping"].items():
                ...
                content += f"**Training Emphasis**: {subconfig['training_emphasis']}\n\n"
...
"""
            ...
            if "subdomain_mapping" in config:
                for subdomain, subconfig in config["subdomain_mapping"].items():
                    ...
                    tool_mapping["domain_tool_mapping"][full_domain] = {
                        ...
                        "specialist": config["specialist_model"],
                        "voice": subconfig.get("voice_preference", config["voice_preference"]),
    ...
    def _get_tool_definitions(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "equation_solver": {"type": "computational", "output": "step_by_step_solution"},
            ...
            "writing_assistant": {"type": "generative", "output": "writing_suggestions"},
            "grammar_checker": {"type": "analytical", "output": "grammar_corrections"},
            
            # Research tools
            "timeline_creator": {"type": "organizational", "output": "chronological_display"},
            "map_generator": {"type": "visual", "output": "geographic_visualization"},
            "primary_source_analyzer": {"type": "analytical", "output": "source_analysis"},
            
            # Scientific tools
            "data_analyzer": {"type": "computational", "output": "statistical_analysis"},
            "simulation_runner": {"type": "interactive", "output": "simulation_results"},
