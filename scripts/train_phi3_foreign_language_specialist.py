#!/usr/bin/env python3
"""
Train domain-specific Phi-3 specialist for foreign_language.
"""
...
class Phi3DomainTrainer:
    def __init__(self):
        ...
        self.output_dir = "/home/cgbowen/AIWorkspace/models/phi3_language_tutor"
        self.domain = "foreign_language"
        self.max_length = 2048
        
    def load_domain_data(self) -> Dataset:
        """Load domain-specific training data."""
        domain_path = Path("/home/cgbowen/AIWorkspace/fine_tuning/datasets/academic_domains/foreign_language")
        examples = []
