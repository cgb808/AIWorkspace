...
class StandardCalculativeFineTuner:
    ...
    def __init__(self, base_model="microsoft/Phi-3-mini-4k-instruct", subject="mathematics"):
    ...
    def prepare_model(self):
        ...
        try:
            ...
            try:
                ...
                print(f"✅ Model loaded successfully without quantization")
            except Exception as e2:
                print(f"❌ Failed to load model even without quantization: {e2}")
                raise e2
        
    def execute_phase(self, phase_key, train_dataset, output_dir, previous_checkpoint=None):
...
def main():
    ...
    parser.add_argument("--subject", required=True, choices=["mathematics", "english", "science"])
