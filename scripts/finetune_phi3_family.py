        ...
        with open(path, 'r', encoding='utf-8') as f:
            for line_num, line in enumerate(f, 1):
                try:
                    ...
                    self.examples.append(ChatExample(
...
def main():
    ...
    train_path = Path(os.getenv("TRAIN_FILE", "data/family_tutor/curated_family_tutor.jsonl"))
    ...
    if not train_path.exists():
        raise SystemExit(f"Training file {train_path} not found. Run family_tutor_curation.py first.")
    ...
    special_tokens = {"additional_special_tokens": ["<|user|>", "<|assistant|>", "<|end|>"]}
    ...
    lora_config = LoraConfig(
        ...
        target_modules=[
            ...
            "gate_proj", "up_proj", "down_proj"  # Phi-3 specific modules
        ],
        lora_dropout=0.05,
        bias="none",
        task_type="CAUSAL_LM",
    ...
    print(f"To use the model, load it with:")
