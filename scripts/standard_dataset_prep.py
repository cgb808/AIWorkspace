...
class StandardDatasetPreparator:
    ...
    def create_combined_dataset(self, download_dir="data/downloaded", output_dir="data/standard"):
...
def main():
    ...
    print("\nUsage examples:")
    print("  python3 scripts/standard_calculative_finetune.py --train-file data/standard/mathematics_standard_dataset.jsonl --subject mathematics --output-dir models/")
    print("  python3 scripts/standard_calculative_finetune.py --train-file data/standard/english_standard_dataset.jsonl --subject english --output-dir models/")
