            ...
            for line in f:
                try:
                    ...
                    if name and core_idea:
                        ...
                        prompt = f"Tell me about {name} and their main philosophical ideas."
...
def main():
    parser = argparse.ArgumentParser(description="Curate enhanced family tutor dataset with stoic/educational content")
    parser.add_argument('--output', default='data/family_tutor/enhanced_family_tutor.jsonl',
                       help='Output JSONL file path')
    parser.add_argument('--seed', type=int, default=42,
                       help='Random seed for reproducibility')
    parser.add_argument('--eli5-count', type=int, default=500,
                       help='Maximum ELI5 examples to include')
    parser.add_argument('--safety-count', type=int, default=30,
