            ...
            teaching_techniques.append(
                {
                    ...
                    "response": "[METHODOLOGY_RESPONSE] Let me guide you through this step by step. First, let's identify what specific part needs clarification. Can you point to where your understanding starts to feel uncertain? This helps me tailor my explanation to your exact needs and build from what you already know.",
                }
            )
            ...
            socratic_examples.append(
                {
                    ...
                    "response": "[SOCRATIC_RESPONSE] That's an interesting point. What makes you think that? Can you walk me through your reasoning? What evidence supports that conclusion? How does this connect to what we discussed earlier? What would happen if we changed one element of this situation?",
                }
            )
            ...
            adaptive_examples.append(
                {
                    ...
                    "response": "[ADAPTIVE_RESPONSE] I notice you learn best when we approach this differently. Let me adjust my teaching style to match how you process information. This isn't about changing the content - it's about finding the path that works best for your learning style.",
                }
            )
