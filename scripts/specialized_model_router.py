    ...
    def __init__(self, ollama_url="http://localhost:11435"):
        ...
        self.SPECIALIZED_MODELS = {
            "mathematics": {
                "model": "phi3:mini", 
                "keywords": [
                    "math", "mathematics", "calculate", "solve", "equation", "number",
                    "add", "subtract", "multiply", "divide", "fraction", "decimal",
                    "algebra", "geometry", "trigonometry", "calculus", "statistics",
                    "problem", "word problem", "percentage", "ratio", "proportion"
                ],
            ...
            "english": {
                "model": "phi3:mini",
                "keywords": [
                    "english", "writing", "grammar", "literature", "reading", "comprehension",
                    "essay", "paragraph", "sentence", "vocabulary", "spelling", "poetry",
                    "story", "narrative", "analysis", "interpretation", "language", "text",
                    "author", "character", "theme", "plot", "setting", "dialogue"
                ],
