...
def main():
    ...
    for dataset_id, info in downloader.PRIORITY_DATASETS.items():
        ...
        print(f"Priority: {info['priority']} | Subject: {info['subject']} | Format: {info['format']}")
    ...
    print(f"   Use these high-quality tutoring datasets in place of general educational content")
