#!/usr/bin/env python3
"""
Train domain-specific Phi-3 specialist for mathematics.
"""
...
class Phi3DomainTrainer:
    def __init__(self):
        ...
        self.output_dir = "/home/cgbowen/AIWorkspace/models/phi3_mathematics_tutor"
        self.domain = "mathematics"
        self.max_length = 2048
        
    def load_domain_data(self) -> Dataset:
        """Load domain-specific training data."""
        domain_path = Path("/home/cgbowen/AIWorkspace/fine_tuning/datasets/academic_domains/mathematics")
        examples = []
