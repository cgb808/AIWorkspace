...
class TutoringDatasetConverter:
    ...
    def convert_gsm8k_step_by_step(self):
        ...
        print(
            f"   ✅ Converted {len(converted_examples)} GSM8K examples to {output_file}"
        )
    ...
    def convert_socratic_teaching(self):
        ...
        input_file = (
            self.input_dir / "KarthikaRajagopal_socratic_teaching_dataset_sample.jsonl"
        )
        ...
        print(
            f"   ✅ Converted {len(converted_examples)} Socratic examples to {output_file}"
        )
        return len(converted_examples)
...
def main():
    ...
    print("=" * 50)
    print(
        "Converting tutoring datasets to instructional format for calculative fine-tuning..."
    )
    ...
    print("   These datasets focus on actual tutoring methodologies")
    print("   Including step-by-step reasoning and Socratic questioning")
