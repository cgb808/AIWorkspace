...
ACADEMIC_DOMAINS = {
    "mathematics": {
        ...
        "keywords": ["math", "algebra", "geometry", "trigonometry", "calculus", "equation", "formula", "solve", "calculate", "arithmetic", "number", "fraction", "decimal", "polynomial", "derivative", "integral"],
        "specialist": "phi3_mathematics_tutor",
        "voice": "jarvis",
        "tools": ["calculator", "graphing", "latex_renderer", "equation_solver"]
    },
    "english": {
        "subdomains": ["creative_writing", "reading_comprehension", "american_literature"],
        "keywords": ["english", "writing", "literature", "reading", "comprehension", "essay", "story", "poem", "grammar", "vocabulary", "author", "character", "plot", "theme"],
        "specialist": "phi3_english_tutor",
        "voice": "alan",
        "tools": ["text_analyzer", "writing_assistant", "literature_database"]
    },
    "science": {
        "subdomains": ["environmental_science", "physics", "astronomy", "forensic_science", "oceanography", "botany", "earth_science", "geology", "physical_science", "zoology", "anatomy", "computer_science", "food_science"],
        "keywords": ["science", "physics", "chemistry", "biology", "astronomy", "geology", "environmental", "anatomy", "zoology", "botany", "experiment", "lab", "hypothesis", "data", "observation"],
        "specialist": "phi3_science_tutor",
        "voice": "jarvis",
        "tools": ["data_analyzer", "simulation_runner", "lab_guide", "formula_renderer"]
    },
    "history": {
        "subdomains": ["civics", "us_history", "world_history", "economics", "regional_history/west_virginia"],
        "keywords": ["history", "historical", "civilization", "war", "politics", "government", "economy", "culture", "society", "timeline", "era", "period", "revolution", "democracy"],
        "specialist": "phi3_history_tutor",
        "voice": "jarvis",
        "tools": ["timeline_creator", "map_generator", "primary_source_analyzer"]
    },
    "art": {
        "subdomains": ["foundational", "abstract", "history_of_art", "performing", "music_theory", "visual_arts"],
        "keywords": ["art", "music", "painting", "drawing", "sculpture", "performance", "theater", "dance", "composition", "rhythm", "melody", "color", "design", "aesthetic"],
    ...
    "foreign_language": {
        ...
        "keywords": ["spanish", "french", "italian", "language", "grammar", "vocabulary", "pronunciation", "translation", "culture", "conversation", "verb", "noun", "adjective"],
...
class AcademicDataOrganizer:
    ...
    def analyze_existing_data(self) -> Dict[str, List[str]]:
        ...
        for jsonl_file in self.datasets_path.rglob("*.jsonl"):
            if "academic_domains" not in str(jsonl_file):  # Skip already organized files
    ...
    def _categorize_file(self, file_path: Path) -> List[str]:
        ...
        if any(word in file_name for word in ["math", "gsm8k", "arithmetic", "algebra"]):
    ...
    def _generate_domain_training(self, domain: str, config: Dict, count: int) -> List[Dict]:
    ...
    def _generate_tool_integration(self, domain: str, config: Dict, count: int) -> List[Dict]:
        """Generate tool integration examples."""
        examples = []
        tools = config["tools"]
    ...
    def _generate_socratic_examples(self, domain: str, config: Dict, count: int) -> List[Dict]:
        """Generate Socratic questioning examples."""
        examples = []
    ...
    def _generate_assessment_examples(self, domain: str, config: Dict, count: int) -> List[Dict]:
        """Generate assessment examples."""
        examples = []
...
def main():
    ...
    print(f"🚀 Ready for specialist model fine-tuning!")
