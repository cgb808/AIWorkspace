...
async def global_exception_handler(request: Request, exc: Exception):  # pragma: no cover - defensive
...
async def dataset_stream(key: str, packed: bool = False):
    ...
    return StreamingResponse(_iter_file_lines(path), media_type="application/x-ndjson", headers=headers)
