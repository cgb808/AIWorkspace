...
class RedisCache:
	...
	def cache_rag_query_result(self, query: str, top_k: int, result: Any, ttl: int = 300) -> None:
		ns = f"rag:q:{top_k}"
	...
	# Pub/Sub ----------------------------------------------------------
	def publish_build_update(self, content: Dict[str, Any], channel: Optional[str] = None) -> None:
...
def cache_set_json(namespace: str, key: str, value: Any, ttl_seconds: int = 300) -> None:
...
def cache_set_msgpack(namespace: str, key: str, value: Any, ttl_seconds: int = 300) -> None:
...
def cache_rag_query_result(query: str, top_k: int, result: Any, ttl_seconds: int = 300) -> None:
